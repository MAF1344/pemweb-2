...
?>
<?php
$sql = "SELECT pesanan.*, produk.nama AS nama_produk FROM pesanan INNER JOIN produk ON pesanan.produk = produk.id";
$rs = $dbh->query($sql);
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary" href="form_edit_pesanan.php?idedit=<?= $row['id'] ?>">Edit</a>
                                    <a class="btn btn-primary" href="delete_pesanan.php?iddel=<?= $row['id'] ?>" onclick="if(!confirm('Anda Yakin Hapus Data Produk <?= $row['produk'] ?>?')) {return false}">Delete</a>
                                </td>
                            </tr>
                        <?php
                        }
